                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-check form-switch mt-3">
                                            <input class="form-check-input mx-5" type="checkbox" value="1"
                                                name="active" role="switch" id="flexSwitchCheckChecked" checked>
                                                    ...
                                                    @foreach ($treasuries as $treasury)
                                                        <tr class="odd">
                                                            ...
                                                            <td>
                                                                ...
                                                                @else
                                                                <p class="text-danger fw-bold">غير مفعل</p>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                ...
                                                                <a href="{{ route('treasury.destroy', $treasury->id) }}"
                                                                    hidden type="submit"

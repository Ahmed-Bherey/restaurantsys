...
<script src="{{ asset('public/admin/assets/plugins/datatables-buttons/js/buttons.bootstrap4.js') }}"></script>
...
<script src="{{ asset('public/admin/assets/plugins/datatables-buttons/js/buttons.print.js') }}"></script>

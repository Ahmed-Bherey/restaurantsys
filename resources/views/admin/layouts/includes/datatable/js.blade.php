...
<script src="{{ asset('public/assets/plugins/datatables-buttons/js/buttons.bootstrap4.js') }}"></script>
...
<script src="{{ asset('public/assets/plugins/datatables-buttons/js/buttons.print.js') }}"></script>
